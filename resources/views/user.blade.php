    ...
    <nav class="navbar navbar-expand navbar-lihgt" style="justify-content: center;">
        <a class="ancor" href="" style="padding: 8px;"> All</a>
        <a class="ancor" href="" style="padding: 8px;"> Men</a>
        <a class="ancor" href="" style="padding: 8px;"> Women</a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-sm-5 d-flex justify-content-center">
                    <a class="btn text-light fw-bold px-5 py-3 " style="background-color: #3b5998; " href="" target="_self">
                        Find Me on Facebook
                    </a>
                </div>

                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-sm-5 d-flex justify-content-center">
                    <a class="btn text-light fw-bold px-5 py-3" style="background-color: #E1306C; " href="" target="_self">
            ...
            <p class="text-light fw-lighter text-center">
                <span>&#169</span> 2023 <span style="font-family: Alex brush; font-size: 28px;">Fashion</span> : Created Made by <span class="fw-bold"> Emanoel Safwat</span>
            </p> <br>
